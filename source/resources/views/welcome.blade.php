...
<body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 items-center lg:justify-center flex-col">

    <img src="logo.png" class="max-w-16 max-h-16">
    <main class="text-white w-full max-w-xl p-6 rounded-2xl shadow-lg bg-[#1b1b18] dark:bg-[#1f1f1f] space-y-6">
       <div class="flex justify-center items-center h-16">
            <span class="text-lg">Server running</span>
        </div>
        <div class="flex justify-center items-center h-16">
            <span class="text-lg">API Endpoint: /api</span>
        </div>
        <br>
        <div class="flex justify-center items-center h-16">
            <span id="serverTime" class="font-mono text-sm">--:--:--</span>
        </div>
    </main>
    <script>
        function updateTime() {
